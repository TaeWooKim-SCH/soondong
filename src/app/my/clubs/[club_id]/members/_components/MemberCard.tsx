...
export default function MemberCard({ adminId, clubId, memberInfo }: PropsType) {
  const joinQuestions: [string, string[]][] | null = memberInfo.join_questions ? Object.entries(memberInfo.join_questions) : null;
  // TODO: 커스텀훅으로 구현  
